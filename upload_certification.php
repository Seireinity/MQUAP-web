              ...
              <form method="post" id="import_excel_form" enctype="multipart/form-data">
                <table class="table">
                  <tr>
                    ...
                    <td width="25%"><input type="submit" name="import" id="import" class="btn" style = "background-color: #EC1D25; color: #FFFFFF"  value="Upload Certification" /></td>
                  </tr>
                </table>
              </form>
           <br />
  ...
  $('#import_excel_form').on('submit', function(event){
    ...
    $.ajax({
      ...
      success:function(data)
      {
        ...
        $('#import').val('Upload Certification');
      }
    })
  });
});
