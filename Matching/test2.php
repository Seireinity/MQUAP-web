...
$courses = $y; //certification content

//get dot product 
$dot = Similarity::dot(call_user_func_array("array_merge", array_column($courses, "tags")));

//get cosine similarity by the dot product
foreach ($courses as $course) {
	$score[$course['course']] = Similarity::cosine($wordsTarget, $course['tags'], $dot);
}
...
<head>
	...
	<title> MQUAP | Course Percentage</title>
